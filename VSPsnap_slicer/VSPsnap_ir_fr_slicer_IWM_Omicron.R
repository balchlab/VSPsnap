...
for(i in 1:nrow(cov_proteins)){
 ...
 getMapSlice(cov_proteins$chromStart[i],cov_proteins$chromEnd[i],cov_proteins$name[i],cov_proteins$L[i],29903,lzn.kriged_df,krige_df,genetab,AF_tab,dt,muts=T,minVar=F,IWM=F)
