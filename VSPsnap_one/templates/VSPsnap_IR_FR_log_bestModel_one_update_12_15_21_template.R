...
# load data
inFiles<-read.delim("../VSPsnap/data/dates_update_12_15_21.tsv",header=F)$V1
...
out<-krige.cv(FR~1,krige_tab,lzn.fit,nmin=5,nmax=50,nfold=5)
...
if(contour==T){
  ...
  # all annotations
  dots_tab_combo<-rbind(dots_tab_B117,dots_tab_P1,dots_tab_B1351,dots_tab_B1617,dots_tab_Omicron)
  dots_tab_combo=dots_tab_combo[!duplicated(dots_tab_combo$name),]


  if(nrow(dots_tab_combo)>0){
  colsL <- c("1" = "black", "2" = "green4", "3" = "blue3", "4" = "brown4","5" = "purple3")
