...
B1617<-read.xlsx("../VSPsnap/data/omicron_8_22_21.xlsx",sheetIndex=1)
...
for(i in c(211,218,225,232,239,246,253,260,267,274,281,288,295,302,309,316,323,330,337,344,351,358,365,372,379,386)){
  print(i)
...
if(contour==T){
  ...
  ggsave(pred.plot_contour3_B1617,filename = sprintf("ctTen_Omicron_black_%03d.png",i),width = 10, height = 7)
